...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['effectId'], ['effects.id'], ),
    sa.ForeignKeyConstraint(['particleId'], ['particles.id'], ),
    sa.ForeignKeyConstraint(['skinId'], ['skins.id'], ),
    sa.ForeignKeyConstraint(['userId'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['backgroundId'], ['backgrounds.id'], ),
    sa.ForeignKeyConstraint(['effectId'], ['effects.id'], ),
    sa.ForeignKeyConstraint(['engineId'], ['engines.id'], ),
